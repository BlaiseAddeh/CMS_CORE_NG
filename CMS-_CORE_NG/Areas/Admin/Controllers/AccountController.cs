...
namespace CMS__CORE_NG.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class AccountController : Controller
    {
        ...
        public AccountController(IOptions<AppSettings> appSettings, IServiceProvider provider,
            ApplicationDbContext db, IAuthSvc authSvc, ICookieSvc cookieSvc,
        ...
        {
            await Task.Delay(0); // Cette ligne juste pour eviter un warning au niveau de la méthode Login
